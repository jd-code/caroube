...
/*
 * $Log: readsample.cpp,v $
 * Revision 1.5  2004/07/02 07:30:56  jd
 * some endianess corrected at file extension detection
 *
 * Revision 1.4  2004/04/30 16:33:05  jd
 * tunings for mingw
 * sample ref count bugs
 *
 * Revision 1.3  2003/10/29 23:38:11  jd
 * stripped the filename extension when building sample's short name
 *
 ...
 * caroube librarised
 *
 * Revision 1.7  2003/05/20 12:39:12  jd
 * springtime cleanup
 * removal of old (commented) code about endianess from groovit C code
 *
 * Revision 1.6  2003/05/11 21:09:07  jd
 * merge with grapefruit lib
 *
 * Revision 1.5  2003/02/27 23:38:25  jd
 * nested all audio into namespace "caroube"
 *
 * Revision 1.4  2003/02/25 16:15:00  jd
 * extended name-use in samplesonge inheritants
 *
 * Revision 1.3  2003/02/21 00:09:39  jd
 * corrected stream-in binary bug on win32
 * added --enable-build-for-win32 switch to configure
 *
 * Revision 1.2  2003/02/16 00:22:54  jd
